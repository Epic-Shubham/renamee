...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([[
      InlineKeyboardButton('📢 Updates', url='https://t.me/anime_bash_offical'),
      InlineKeyboardButton('💬 Support', url='https://t.me/anime_bash_chat')
    ],[
      InlineKeyboardButton('⚙️ Help', callback_data='help'),
      InlineKeyboardButton('💙 About', callback_data='about')
    ],[
        InlineKeyboardButton("🧑‍💻 Kalla Kutta 🧑‍💻", url='https://t.me/MK255')
    ]])
    if Config.START_PIC:
    ...
    if data == "home":
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([[
                ...
                InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url='https://t.me/Rcbkafan')
                ]])
        )
    elif data == "caption":
        await query.message.edit_text(
